...
CLASSES = ('__background__',
           'aeroplane', 'backpack', 'bicycle', 'bird', 'boat',
...
def parse_args():
    ...
    parser.add_argument('--cpu', dest='cpu_mode',
                        ...
                        action='store_true')
    parser.add_argument('--list', '-l',help='image list file')
...
if __name__ == '__main__':
    ...
    for i in files:
        ...
        if im == None:
            print "Can't open {}".format(i)
            continue
        res = detect(net, im)   
        if res[1] == 0:
 #           print 'No target class in ' + i
            continue
        outpath = os.path.join(args.outdir, i+'_out.jpg')
