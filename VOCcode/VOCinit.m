...
VOCopts.annopath=[VOCopts.datadir 'Annotations/%s'];
%VOCopts.imgpath=[VOCopts.datadir VOCopts.dataset '/Images/%s.jpg'];
VOCopts.imgpath=[VOCopts.datadir 'Images/%s'];
VOCopts.imgsetpath=[VOCopts.datadir '%s'];
...
VOCopts.classes=textread([VOCopts.datadir 'classes.lst'],'%s')
